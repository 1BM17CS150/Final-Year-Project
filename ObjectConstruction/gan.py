...
class Generator:
    def __init__(self, depths=[1024, 512, 256, 128], s_size=4, nb_channels=1):
...
class Discriminator:
    def __init__(self, depths=[64, 128, 256, 512], nb_channels=1):
...
class GAN:
    def __init__(self,
                 batch_size=128, s_size=4, z_dim=100, nb_channels=1,
        ...
        print('Contextual Loss: %s, Complete Loss: %s, Adversarial Loss: %s' % (self.contextual_loss, self.complete_loss, self.adversarial_loss))
